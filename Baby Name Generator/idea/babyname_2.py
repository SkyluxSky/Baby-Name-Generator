...
#great to create our own functions, 5 seperate random letters for 5 seperate variables
def generator():
...
#now lets get crazy with some conditionals
...
if letter_input_1 == "v":
    ...
    letter1 = letter_input_1 #allows user to select a Specific letter
...
if letter_input_2 == "v":
    ...
    letter2 = letter_input_2 #allows user to select a Specific letter
...
if letter_input_3 == "v":
    ...
    letter3 = letter_input_3 #allows user to select a Specific letter
...
if letter_input_4 == "v":
    ...
    letter4 = letter_input_4 #allows user to select a Specific letter
...
if letter_input_5 == "v":
    ...
    letter5 = letter_input_5 #allows user to select a Specific letter
